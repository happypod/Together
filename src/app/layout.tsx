...
const preferenceBootScript = `(function(){try{var d=document.documentElement;var s=localStorage.getItem('together.fontScale');var c=localStorage.getItem('together.contrast');d.setAttribute('data-font-scale',(s==='large'||s==='xlarge')?s:'normal');d.setAttribute('data-contrast',c==='high'?'high':'normal');}catch(e){}})();`;
...
export default function RootLayout({
  ...
  return (
    <html data-font-scale="normal" data-contrast="normal" lang="ko" suppressHydrationWarning>
      <body>
